            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                <h1 className="font-headline text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
                  <span className="text-primary">Motor Insurance</span>
                </h1>
                <p className="mt-4 text-lg md:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0">
                  Protect your vehicle against accidents, theft, and damages. Find the best motor insurance policy for your car.
                </p>
              </div>
              <InsuranceForm
