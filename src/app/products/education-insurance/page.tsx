...
export default function EducationInsurancePage() {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                <h1 className="font-headline text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
                  <span className="text-primary">Education Insurance</span>
                </h1>
                <p className="mt-4 text-lg md:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0">
                  Invest in your child's future. An education plan ensures their learning journey is never compromised.
                </p>
              </div>
              <InsuranceForm
